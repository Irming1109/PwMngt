...
(e.g. "Charger 2"), add a dict here -- the number/select/button/text/sensor
...
def charger_device_info(entry: ConfigEntry, charger: dict) -> DeviceInfo:
    ...
    via via_device, so it shows up nested under "Power Management" in the
